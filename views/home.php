...
<head>
    ...
    <style>
        ...
        .card-product { background: #fff; border-radius: 8px; padding: 15px; margin-bottom: 20px; box-shadow: 0 1px 2px 0 rgba(60,64,67,.1); transition: all 0.3s; position: relative; display: block; text-decoration: none; color: inherit; height: 100%; }
        ...
        .product-name { font-size: 14px; font-weight: bold; color: #333; margin-bottom: 8px; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
        ...
        .rating { color: #fb6e2e; font-size: 12px; margin-top: 5px; }
    </style>
</head>
<body>
    ...
    <header class="tgdd-header sticky-top">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <a href="#" class="btn btn-dark fw-bold rounded-pill px-4"><i class="bi bi-cart3"></i> Giỏ hàng</a>
        </div>
    </header>
            ...
            <?php if(count($phones) > 0): ?>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <a href="#" class="card-product">
                        ...
                        <div class="product-name"><?= htmlspecialchars($phone['name']) ?></div>
                        ...
                        <div class="rating">
                            <?= number_format($phone['rating'], 1) ?> <i class="bi bi-star-fill"></i>
